...
#   process serves dist/ and relays the station WebSockets (station/README.md).
...
# Liveness only: an unreachable M5 or closed windows must not restart the
# station. /health answering means the process serves and relays.
