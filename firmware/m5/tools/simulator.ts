 ...
 * Boundary: A Bun process outside the app bundle. The payload uses the shared
 *   src/m5/protocol.ts contract; steering behavior lives in the app.
 *
