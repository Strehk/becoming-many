...
| Implemented | Previous #80 → #73 → #20 block committed at `0a746e7`. The user authorized continuation after its concrete 3/3 report. New block #27 → #26 → #32 starts at 0/3 implemented; #27 is in progress. |
...
authorized; the next block starts at 0/3. Early physical commissioning is not
...
| --- | --- |
| Current human gate | Continuation after the concrete #80/#73/#20 report is authorized at `0a746e7`; next block 0/3. Individual listening/device acceptance and #73 technical verification remain unresolved. |
