...
Boundary: Current implementation details remain in code-architecture.md and current-status.md.
-->
...
- Keep `current-status.md` factual, `code-architecture.md` implementation-based,
