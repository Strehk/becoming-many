...
This document describes the **as-built** architecture of the imported working
codebase. The authoritative **target** architecture for the installation is
[architecture.md](architecture.md) — where the two disagree, the target
architecture takes priority and the code is what gets adapted.
