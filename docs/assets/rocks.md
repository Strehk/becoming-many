...
`public/models/rocks` contains four Quaternius GLBs from Poly Pizza. All are CC0 and
their source pages, direct downloads, and checksums are recorded in
`public/models/rocks/provenance.json`.

| Runtime ID | Source | File | Selected object |
| --- | --- | --- | --- |
| Rock pack | [Poly Pizza](https://poly.pizza/m/gYhoEOKItJ) | `rock-pack.glb` | `Rock_2` |
| Medium rock | [Poly Pizza](https://poly.pizza/m/KZdEP3uUpa) | `rock-medium.glb` | `Rock_Medium_2` |
| Small rocks | [Poly Pizza](https://poly.pizza/m/OQvi8PIZ40) | `rock-small.glb` | `Rock_3` |
| Gold rock | [Poly Pizza](https://poly.pizza/m/49NgnJzOHc) | `gold-rock.glb` | `Resource_Gold_3` |
...
LOD remain deferred until target Windows-PCVR measurement requires them.
