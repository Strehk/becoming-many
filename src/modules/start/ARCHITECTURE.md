...
-31.20 dB to -43.20 dB during speech. Positional attenuation feeds one shared hall and limiter;
...
Atmosphere levels in `audio/audio-settings.ts` include two successive 20%
amplitude increases (+3.16725 dB total) across pulse, clicking and base. Both pad
levels include successive 20% and 15% increases (+2.797582 dB total). Speech ducking remains 12 dB
and all fade durations remain unchanged.
