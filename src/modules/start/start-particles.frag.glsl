...
uniform vec3 startArrowAccent;
uniform vec3 startCrossingAccent;
...
void applyStartParticleAppearance(inout vec4 particleColor) {
  ...
  particleColor.rgb = mix(particleColor.rgb, startArrowAccent, startArrowAccentStrength * 0.14);
  particleColor.rgb = mix(particleColor.rgb, startCrossingAccent, startLocalPulse * 0.18);
