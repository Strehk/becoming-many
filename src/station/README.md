...
Vite development and preview run independently with empty deployment defaults.
To test deployment facts, build and run the Bun station server deliberately.
