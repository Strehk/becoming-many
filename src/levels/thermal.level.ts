/**
 * Purpose: Define the independent Thermal Perception startup preset.
 * Context: Direct routes and benchmarks can start this world without earlier levels.
 * Responsibility: Own the presentation of Thermal Perception and name its modules explicitly.
